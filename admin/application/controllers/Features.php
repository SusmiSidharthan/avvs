...
class Features extends MY_Auth_Controller {
	...
	public function create() {
    	...
    	$this->form_validation->set_rules('name', 'Feature Name', 'trim|required|xss_clean');
    ...
    public function view() {
        ...
        $data['features'] = $this->model->getFeatureVariants($id);
        $data['categories'] = $this->model->getSelectedCat($id);
