...
class Options extends MY_Auth_Controller {
    ...
    public function create() {
        ...
        $this->form_validation->set_rules('name', 'Option Name', 'trim|required|xss_clean');
    ...
    public function view() {
        ...
        $data['options'] = $this->model->getOptionsList($id);
        $data['categories'] = $this->model->getOptionsCat($id);

        $this->load->view('option/view', $data);
    }
