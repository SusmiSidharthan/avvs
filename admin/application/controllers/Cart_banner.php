...
class Cart_banner extends MY_Auth_Controller {
    ...
    public function create() {
	    ...
	    else 
	    {
	        ...
	        if(empty($banner_type)) {
	        	...
	        	$value = array('banner_name' => $banner_name,'date'=> date("Y-m-d H:i:s"),'image' => $image_name);
		    }
		    else {

	        	$value = array('banner_name' => $banner_name,'banner_type' => $banner_type,'type_id' => $type_id,'date'=> date("Y-m-d H:i:s"),'image' => $image_name);
		    }
	...
	public function edit() {
	 	...
	 	$banner_type = $this->model->getbannerType($id);
	 	$data['result'] = $this->model->getBanner($id);

	 	if($banner_type == 'home' || $banner_type == 'home_ad' || $banner_type == 'speciality-clinic'){
	    ...
	    $this->load->view('banner/edit2',$data);		
		...
		if (isset($_POST['submit'])) 
		{
            ...
            $this->image->generalCropAdd();//call custom image library
		    	...
		    	else if($location_name !="")
		    	{
					...
					$value = array('banner_name' => $banner_name,'date'=> date("Y-m-d H:i:s"),'address' => $address,'postal_code' => $postal,'latitude' => $lat,'longitude' => $long,'country' => $country);
		    	}

		    	else if($banner_type !="")
		    	{

					$value = array('banner_type' => $banner_type,'type_id' => $type_id,'banner_name' => $banner_name,'date'=> date("Y-m-d H:i:s"));
		    	}

		    	else
		    	{
			    	 $value = array('banner_name' => $banner_name,'date'=> date("Y-m-d H:i:s"));
		    	}
    ...
    public function create2() {
	    ...
	    else 
	    {
	    	...
	    	$this->image->generalCropAdd2();//call custom image library
