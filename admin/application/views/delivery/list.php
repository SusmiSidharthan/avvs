          ...
          <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>delivery_charge/create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
...
<!-- /.content -->
    ...
    <div class="modal fade kg-modal" id="kg-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
               <div class="kg"></div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Delivery_charge/cat_list'); ?>',
        "type": "POST",
        },
        });
      ...
      $(function () {
        ...
        $(document).ready(function () {
                ...
                $('#del').on('show.bs.modal', function (e) {
                    ...
                    $.ajax({
                type: 'post',
                url: '<?php echo site_url('Delivery_charge/delete'); ?>', //Here you will fetch records 
