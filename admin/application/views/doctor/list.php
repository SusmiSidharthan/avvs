          ...
          <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>consulting/doctor_create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
...
<!-- /.content -->
    ...
    <div class="modal fade slot-modal" id="slot-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Consulting/doctor_list'); ?>',
        "type": "POST",
        },
        });
    });
      ...
      $(function () {
        ...
        $(document).ready(function () {
                ...
                $('#del').on('show.bs.modal', function (e) {
                    ...
                    $.ajax({
                type: 'post',
                url: '<?php echo site_url('Consulting/doctor_delete'); ?>', //Here you will fetch records 
...
<script>
    $(document).ready(function () {
        ...
        $('#slot-modal').on('show.bs.modal', function (e) {
            var rowid = $(e.relatedTarget).data('id');
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Consulting/slot'); ?>',
                data: 'rowid=' + rowid, //Pass $id
