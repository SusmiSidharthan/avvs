...
<p><br></p>
              ...
              <div class="col-md-6"> 
                <div class="form-group">
                 <label class="form-control-label" for="inputUserName">MRP (QR) <span class="man-in">*</span></label>
                ...
                <div class="col-md-6">                                        
                 <div class="form-group">
                  <label class="form-control-label" for="inputUserName">Sale price (QR) </label>
                ...
                <div class="col-md-6"> 
                 <div class="form-group">
                 <label class="form-control-label" for="inputUserName">KG </label>
                 <input type="number" step="0.001" class="form-control" id="inputUserName" name="kg" value="<?php echo set_value('kg'); ?>" >
                 <?php echo form_error('kg', '<p class="invaild-9-field">', '</p>'); ?>
                 </div>                  
                </div>
                    ...
                    <div class="col-md-12">
                     <div class="form-group">
                      <label class="form-control-label" for="inputUserName">Options</label>

                    
                      

                          <?php foreach ($option as $key => $res) { print_r($res->name) ?>

                         <select class="form-control" id="company" name="option[]">
                          <option value="">Select</option>

                          <?php foreach ($res->sub as $key => $resub) {  ?>
                        
                          <option value="<?= $resub->var_id;?>"  <?php echo set_select('category',$resub->var_id, False); ?> ><?php echo $resub->var_name ?></option>
