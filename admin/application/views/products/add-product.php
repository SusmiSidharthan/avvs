                ...
                <div class="wizard-pane active" id="exampleAccountOne" role="tabpanel">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input required type="text" class="form-control" id="inputUserName" name="product_name">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="inputUserName">Category <span class="man-in">*</span></label>
                         <select data-live-search="true" class="form-control selectpicker" id="company" name="category" onChange="showSub(this);" required>
