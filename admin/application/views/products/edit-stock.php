    ...
    <div class="box box-primary">
             ...
             <div class="container-fluid">
              ...
              <div class="col-md-6"> 
                ...
                <input type="number" step="0.001" class="form-control" id="kg" name="kg" value="<?= (set_value('kg') != '') ? set_value('kg') : $row['kg']; ?>" >
                </div> 
                    ...
                    <div class="col-md-6">
                      ...
                      <label class="form-control-label" for="inputUserName">Option</label>
                    ...
                    <div class="form-group">
                         ...
                         <select class="form-control" id="company" name="option[]">
                          ...
                          <?php foreach ($res->sub as $resub) {  ?>
                        
                          <option value="<?= $resub->var_id;?>"  <?php if(!empty($row['option'][$key]))
                            { if ($resub->var_id == $row['option'][$key]->var_id) { ?> selected="selected" <?php } } ?> ><?php echo $resub->var_name ?></option>
