                            ...
                            <tbody>
                                ...
                                foreach ($stock as $row) { ?>
                                  ...
                                  <tr>
                                        ...
                                        <a data-id="<?= $row['id'] ?>" data-name="<?= $row['image'] ?>" data-toggle="modal"  data-target="#delModal" href="#"><i class="fa fa-trash" aria-hidden="true"></i></a> 
                                        <a href="<?= CUSTOM_BASE_URL . 'product/image/'.$row['id'].'/'.base64_encode($product_name .SALT_KEY).'/'.$cat_id; ?>" class="cte-edit">Images</a>
                                        </td>
