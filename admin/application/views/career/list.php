          ...
          <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>career/create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('career/career_list'); ?>',
        "type": "POST",
        },
        });
    });
