...
<html>
 ...
 <?php include('assets/include/navigation.php'); ?>
      ...
      <div class="content-wrapper">
       ...
       <!-- VIEW MODAL BODY -->
        <div class="modal fade" id="paymentview-modal" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content model_gallery">
                    <div class="modal-body">
                        <div class="row">
                            <!----modal calling div-->
                            <div class="paymentview-modal"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#paymentview-modal').on('show.bs.modal', function (e) {
            var rowid = $(e.relatedTarget).data('id');
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Cart_orders/payment_view'); ?>',
                data: 'rowid=' + rowid,
                success: function (data) {
                    $('.paymentview-modal').html(data);
                }
            });
        });
    });
