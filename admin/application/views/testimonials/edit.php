...
<form enctype="multipart/form-data" method="post" name="myform" action="<?= CUSTOM_BASE_URL . 'testimonials/update' ?>" onSubmit="return checkForm()" >
<?php foreach ($result as $row) {?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
         ...
         <a class="cropModal" data-toggle="modal" data-target="#cropModal">
            <img  class="img-responsive col-md-4" id="previewimages" src="<?php echo base_url();?>uploads/testimonials/crop/<?php echo $row['image']; ?>"></a>
            <div class="error"></div>
        </div>  
  ...
  <div class="modal fade" id="cropModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="col-md-12">
                <div class="form-group">
                    <label>Messgae</label>
                     <textarea name="message" class="form-control" rows="3"><?php echo $row['message']; ?></textarea>
...
window.location = '<?= CUSTOM_BASE_URL . "testimonials" ?>';
});
