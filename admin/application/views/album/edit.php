...
<section class="content">
    ...
    <div class="box box-primary">
     ...
     <form class=" add-ca-in" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>Album/update">
    ...
    <div class="row">
      <div class="col-md-4">
       <div class="form-group">
         <label class="form-control-label" for="inputBasicFirstName">Album Name</label> 
       </div>
      </div>
      <div class="col-md-6">
       <div class="form-group">  
         <input type="text" class="form-control" name="album_name" value="<?= set_value('album_name', isset($row['title']) ? $row['title'] : '') ?>">
         <?php echo form_error('album_name', '<p class="invaild-9-field">', '</p>'); ?>
       </div>
      </div>
    </div>
    ...
    <div class="row">
       <div class="col-md-4">
        <div class="form-group">
         <label class="form-control-label" for="inputBasicFirstName">Thumbnail</label> 
        </div>
       </div>
       <div class="col-md-6">
        <div class="form-group">
           <a data-toggle="modal" data-target="#cropModal"><img height="100" width="100" src="<?= CUSTOM_BASE_URL . 'uploads/album/crop/'.$row['image']; ?>" class="img-responsive"></a>
...
<!--<script type="text/javascript" src="<?= CUSTOM_BASE_URL .'assets/plugins/crop/script_banner.js'?>"></script>-->
  ...
  <?php include('assets/include/footer.php'); ?>
    <script type="text/javascript" src="<?= CUSTOM_BASE_URL .'assets/plugins/crop/script_album.js'?>"></script>
  <script>

    $("#cancel").click(function () {//jquery cancel function when cancel button click
      window.location = '<?= CUSTOM_BASE_URL . "Album" ?>';
