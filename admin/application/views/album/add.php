...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <form class="add-ca-in" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>Album/create" >
<div class="container-fluid">
     ...
     <div class="row">
      ...
      <div class="col-md-6">
       <div class="form-group">  
         <input type="text" class="form-control" name="album_name" value="<?php echo set_value('album_name') ?>">
