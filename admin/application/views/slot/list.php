          ...
          <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>slot/create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Slot/cat_list'); ?>',
        "type": "POST",
        },
        });
    });
      ...
      $(function () {
        ...
        $(document).ready(function () {
                ...
                $('#del').on('show.bs.modal', function (e) {
                    ...
                    $.ajax({
                type: 'post',
                url: '<?php echo site_url('Slot/delete'); ?>', //Here you will fetch records 
...
<script>
  ...
  function Deactive(id='') {
    ...
    $.ajax({
          type: 'post',
          url: '<?= CUSTOM_BASE_URL . 'Slot/deactive' ?>', //Here you will fetch records 
          data: {id:id}, //Pass $id
          dataType: 'JSON',
  ...
  function Active(id='') {
    ...
    $.ajax({
          type: 'post',
          url: '<?= CUSTOM_BASE_URL . 'Slot/active' ?>', //Here you will fetch records 
          data: {id:id}, //Pass $id
          dataType: 'JSON',
          success: function (response) {
