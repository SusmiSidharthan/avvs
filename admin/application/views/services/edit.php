...
<form enctype="multipart/form-data" method="post" name="myform" action="<?= CUSTOM_BASE_URL . 'services/update' ?>" onSubmit="return checkForm()" >
    ...
    <div class="row">
        ...
        <div class="col-md-12">
         ...
         <a class="cropModal" data-toggle="modal" data-target="#cropModal">
            <img  class="img-responsive col-md-4" id="previewimages" src="<?php echo base_url();?>uploads/services/crop/<?php echo $row['image']; ?>"></a>
            <div class="error"></div>
        </div>  
  ...
  <div class="modal fade" id="cropModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
         ...
         <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="canonical_link"   value="<?= (set_value('canonical_link') != '') ? set_value('canonical_link') : $row['canonical_link']; ?>">
...
window.location = '<?= CUSTOM_BASE_URL . "services" ?>';
});
