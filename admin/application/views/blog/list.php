          ...
          <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>blog/create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
      ...
      $(function () {
        ...
        $(document).ready(function () {
                ...
                $('#view-modal').on('show.bs.modal', function (e) {
                    ...
                    $.ajax({
                type: 'post',
                url: '<?php echo site_url('Blog/View'); ?>', //Here you will fetch records 
        ...
        $(document).ready(function () {
                ...
                $('#del').on('show.bs.modal', function (e) {
                    ...
                    $.ajax({
                type: 'post',
                url: '<?php echo site_url('Blog/delete'); ?>', //Here you will fetch records 
                data: 'rowid=' + rowid, //Pass $id
                success: function (data) {
                    $('.project-view').html(data);//Show fetched data from database
                }
