          ...
          <section class="content">
            <div class="box">
                <div class="box-header">
                  <a class="btn bg-olive" href="<?= CUSTOM_BASE_URL;?>Gallery/create">Create</a>
                </div><!-- /.box-header -->
    ...
    $(document).ready(function () {//delete_casestudy modal when edit button click
        $('#delModal').on('show.bs.modal', function (e) 
        {
           ...
           // var cropname = $(e.relatedTarget).data('cropname');
            $.ajax({
                type: 'post',
                url: '<?= CUSTOM_BASE_URL . 'Gallery/delete' ?>', //Here you will fetch records 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Gallery/gallerylist'); ?>',
        "type": "POST",
        },
        });
    });
