...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <form class="add-ca-in" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>cart_banner/create2"  onSubmit="return checkForm()">
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
       <div class="form-group">  
         <select title="Banner Type" class="form-control selectpicker" name="banner_type" onChange="showSub(this);">
                 <option value="gallery">Gallery</option>
                 <option value="gallery-details">Gallery Details</option>
...
<!--      <div class="row">
      ...
      <div class="col-md-6">
       <div class="form-group"> 
         <input type="datetime-local" class="form-control" name="exp_date" value="<?php echo date("d/m/Y"); ?>">
...
<script type="text/javascript" src="<?= CUSTOM_BASE_URL .'assets/plugins/crop/banner_script_new2.js'?>"></script>
