          ...
          <section class="content">
            <div class="box">
                <div class="box-header">
                  <a class="btn bg-olive" href="<?= CUSTOM_BASE_URL;?>cart_banner/create">Home|Speciality Clinic|About</a>
                  <a class="btn bg-olive" href="<?= CUSTOM_BASE_URL;?>cart_banner/create2">Others</a>
                </div><!-- /.box-header -->
