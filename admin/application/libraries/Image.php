...
class Image {
    ...
    function generalCropAdd()
    {
        ...
        {
        $iWidth = 1365 ;
        $iHeight = 590; // desired image result dimensions
        }
    ...
    function generalCropAdd2()
    {
        ...
        {
        $iWidth = 1365 ;
        $iHeight = 480; // desired image result dimensions
        }
    ...
    $ci_name=strtolower($this->CI->router->fetch_class());
     ...
     if (!is_dir('uploads/'.$ci_name))
     {
        ...
        {
        $iWidth = 800;
        $iHeight = 700; // desired image result dimensions
        }
