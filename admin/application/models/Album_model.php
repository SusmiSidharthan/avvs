...
Class Album_model extends MY_model {
    ...
    var $column_search = array('album.id','album.title'); //set column field database for datatable searchable just firstname , lastname , address are searchable
  ...
  private function get_datatables_query()
  {
    ...
    public function insertForAlbum($value) { 
    ...
    public function updateAlbum($id,$value)
    {
        $this->db->where('id',$id);
