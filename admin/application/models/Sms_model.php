...
var $column_search = array('patient_name'); //set column field database for datatable searchable just firstname , lastname , address are searchable
...
private function get_datatables_query()
{
    ...
    $this->db->select("sms.*,DATE_FORMAT(slot.from_time,'%h:%i %p') AS from_time,DATE_FORMAT(slot.to_time,'%h:%i %p') AS to_time");
    $this->db->from($this->table);
    $this->db->join('slot','slot.id = sms.apponment_time');
