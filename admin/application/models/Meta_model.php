...
Class Meta_model extends MY_Model {
  ...
  public function __construct() {
    ...
    var $column_order = array('meta_title',null,null); //set column field database for datatable orderable

    var $column_search = array('meta_title'); //set column field database for datatable searchable just firstname , lastname , address are searchable
