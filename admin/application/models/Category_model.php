...
Class Category_model extends MY_Model {
  ...
  foreach($query->result_array() as $rowCategories){
    ...
    //   $this->db->select('consulting_details.patientname,consulting_details.lastname,consulting_details.age,consulting_details.gender,consulting_details.place,consulting_details.date,consulting_details.timeslot ,
    //                     user_registration.user_name,user_registration.phone,user_registration.prof_image
    //                   ');
