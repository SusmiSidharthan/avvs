...
Class Slot_model extends MY_Model {
  ...
  public function __construct() {
    ...
    var $column_search = array('from_time','to_time'); //set column field database for datatable searchable just firstname , lastname , address are searchable
  ...
  public function checkSlot($from_time='',$to_time='')
  {
