...
<!--      <nav class="applePie nav clearfix">
       <div class="menubtn"><i class="glyph-icon flaticon-menu-button"></i></div>
        <ul id="nav" class="clearfix">
          ...
          <a href="<?= CUSTOM_BASE_URL;?>" class="hda-s-logo hda-s-logo2">
           <img src="<?php echo base_url();?>assets/images/logo-ayurvaram.png" alt="avvvs">  
         </a>
      ...
      <nav class="applePie nav clearfix">
       <div class="menubtn"><i class="glyph-icon flaticon-menu-button"></i></div>
        <ul id="nav" class="clearfix">
            ...
            <!--  </ul> -->
            <!--  <li><a href="#">Ayurvaram</a></li>-->
            <!--  <li><a href="#">Gallery</a></li>-->

            <!--</li>-->
            
            
            <!--<li><a href="<?= CUSTOM_BASE_URL;?>product-list">Store</a></li>-->
