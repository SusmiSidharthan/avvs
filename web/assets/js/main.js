...
var app = {
  ...
  updateTotals: function () {
    ...
    for (var i = 0; i < products.length; i += 1) {
     ...
     //delivery = parseFloat($("#shippingCtr").find(".cart-totals-value").html().strip$());
    
    
   
    var delivery = parseFloat(document.getElementById('del').value);
   ...
   // }
    ...
    $("#totalCtr").find(".cart-totals-value").html( (subtotal));
    $("#shippingCtr").find(".cart-delivery-value").html( (delivery));
    $("#totalCtr").find(".cart-totals-value").html( (subtotal).to_$() );
    $("#shippingCtr").find(".cart-delivery-value").html( delivery.to_$() );
    
    
    //document.getElementById("key_display").value =  (subtotal + shipping);
    
    document.getElementById("key_display").value =  (subtotal);
