        ...
        <div class="col-lg-9 col-xl-9">
         <div class="my-profile-right clearfix">
          <div class="mange-add-ac">
           <h2 class="in-heda-ab">My Appoinment</h2>
            <div class="my-order-ab">
             ...
             <div class="my-ord-out-ac">
              <div class="order-id-ad">
               <a href="#" class="order-id-ag"><?= '#'.$row['consulting_id']; ?></a>
              ...
              Patient Name :<strong> <a class="my-ord-nm-ag" href="#"><?= $row['patientname']; ?><?="  ". $row['lastname']; ?></a> </strong>
               ...
               <div class="order-date-af">
                 Appoinment Date: <?= date("d-m-Y", strtotime($row['date'])); ?>
               </div>  
