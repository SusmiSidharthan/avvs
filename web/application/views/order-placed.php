   ...
   <div class="order-out-ab">
    <div class="row">
     <div class="col-12">   
         ...
         <div class="about-time-order-ab">Thank you for being our valued customer ...
         </div> 
     ...
     <div class="col-11">
      <div class=" orde-cnt-ab-out">  
       ...
       <div class="orde-cnt-ab">
        <h2><?= $order_sub_row['stock_name']; ?></h2>
        <h3>₹ <?= $order_sub_row['sub_total'] * $order_sub_row['qty']; ?></h3>
       </div>   
     </div>
     </div>
    </div>
