<?php include("web/assets/include/header-checkout.php");?>
    ...
    <?php foreach ($product as $key => $stock_rows) { ?>
      ...
      <div class="tabs-panel is-active" id="panel1">   
         ...
         <div class="add-del-ad">
             ...
             <div class="aad-ed-ab">
                   ...
                   <a href="<?= CUSTOM_BASE_URL.'account/single_checkout_delivery_address_edit/'.$address_rows['address_id'].'/'. $product_id?>" class="btn btn-edit-ag" >Edit</a>
                    ...
                    <a href="<?= CUSTOM_BASE_URL.'account/single_deleteCheckoutAddress/'.$address_rows['address_id'].'/'. $product_id?>" class="btn btn-delete-ag" >Delete</a>
        ...
        <?php } } else { ?>
          ...
          <a target="_blank" href="<?= CUSTOM_BASE_URL.'account/create_single_checkout_delivery_address/'. $product_id?>">Please add Delivery Address</a>
                                                         ...
                                                         <div class="rd-dh12">
                                                             ...
                                                             <div class="rd-dh13 clearfix">
                                                              <label>
                                                                ...
                                                                <input type="radio" name="payment_metod" style="display:none" id="option1" autocomplete="off"  value="1">
                                                             ...
                                                             <div class="rd-dh13 clearfix">
                                                              <label >
                                                                <input type="radio" name="payment_metod" id="option2" style="display:none" autocomplete="off" value="2">   
                                                                <div class="rd-dh14">Pay Now</div>
                                                              </label>
                                                             </div>
                                            ...
                                            <div class="crt-cart-totals">
                                             <div class="_grid cart-totals">
                                              ...
                                              <div class="_column total" id="totalCtr">
                                                ...
                                                <div class="cart-totals-value" id="total_value">₹ <?= $stock_rows['list_price']; ?></div>
                                              </div>
  ...
  <?php include("web/assets/include/footer-single-checkout.php");?>
