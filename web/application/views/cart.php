    ...
    <div class="ui-list shopping-cart--list" id="shopping-cart--list">
      ...
      <div id="shopping-cart--list-item-template">
        ...
        <div class="_grid shopping-cart--list-item">
          ...
          <div class="crt-price product-single-price">RS: <?= $row['list_price']; ?></div>
            <button value="<?= $row['id']; ?>" class="_btn entypo-trash product-remove">X Remove</button>
          </div>
          <div class="crt-product-col _column product-modifiers" data-product-price="<?= $row['list_price']; ?>">
           ...
           <!-- <div  class="price product-delivery-price">Rs: <?= $charge*1; ?></div>-->
          </div>
        </div>
     ...
     <div class="_grid cart-totals">
      ...
      <!--  <div class="cart-totals-value">Rs:  <?= $row['sub_total']; ?></div>-->
      <!--</div>-->
      
<!--       <div class="_column shipping" id="shippingCtr">
        <div class="cart-totals-key">Shipping</div>
        <div class="cart-delivery-value">Rs: <?= $charge; ?></div>
      </div> -->
      
      <!--<input class="cart-delivery-value" type="hidden" name="delivery_charge" id="delivery_charge" value="<?php echo $charge; ?>">-->
      ...
      <!--<div class="_column total" id="deliveryAmt">-->
      <!--  <div class="cart-totals-key">Delivery Charge</div>-->
      <!--  <div class="cart-delivery-value">Rs: <?= $charge; ?></div>-->
      <!--</div>-->
      ...
      <div class="che-ck12">
        <a href="<?= CUSTOM_BASE_URL ?>product-list" class="_btn-b checkout-btn entypo-forward">Continue Shopping</a>
        <a href="<?= CUSTOM_BASE_URL;?>checkout" class="checkout-btn">Checkout</a>
      </div>
    </div>
   </div>
         </div>
