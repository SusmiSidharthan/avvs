          ...
          <div class="my-pro-ac">
            <form enctype="multipart/form-data" method="post" action="<?= CUSTOM_BASE_URL . 'profile-update' ?>">
              ...
              <div class="form-group">
                ...
                <input name="mobile"  type="text" onkeypress="return (event.charCode >= 48 &amp;&amp; event.charCode <= 57)" minlength="10" maxlength="10" class="pro-fld-ad" id="formGroupExampleInput2" value="<?= $row['phone'] ?>" >
              </div>
              <div class="form-group">
