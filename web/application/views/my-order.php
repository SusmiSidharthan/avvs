       ...
       <!-- Left side -->
        <div class="col-lg-3 col-xl-3">  
         ...
         <div class="my-name-txt">
            ...
            <!--    <img class="img-responsive" src="<?= CUSTOM_BASE_URL . 'admin/uploads/profile/'.$row['prof_image']; ?>"  />-->
            <!--</div>-->
          ...
          <ul class="my-name-lnk">
           ...
           <li>
            <a href="<?= CUSTOM_BASE_URL. 'my-appoinment' ?>">
             ...
             <div class="my-ord-out-ac">
              <div class="order-id-ad">
               <a href="#" class="order-id-ag"><?= '#'.$row['id']; ?></a>
                  ...
                  <?php if($row['status'] == 2){ ?>
                  <button type="button" class="order-rate-ah" data-toggle="modal" data-target="<?= '#cancel'.$row['sub_id']; ?>">Cancel Product</button>
         ...
         <div class="form-group">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">Post</button>
                    ...
                    <!-- Cancel Modal -->
<div class="modal fade rating-model-ah" id="<?= 'cancel'.$row['sub_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="cancel-modal">Cancel</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="clasificacion">
       <div class="prd-rating-m">
        <form enctype="multipart/form-data" method="post" action="<?= CUSTOM_BASE_URL . 'product-cancel' ?>">
            ...
            <button type="submit" class="btn btn-primary">Submit</button>
              ...
              <div class="my-ord-ab-out">  
               ...
               <div class="my-ord-txt-ab">
                <a class="my-ord-nm-ag" href="<?= CUSTOM_BASE_URL . 'product-details/'.$itemckratt; ?>"><h2><?= $row['stock_id']; ?><?= $row['stock_name']; ?></h2></a>
                <div class="my-ord-txt-ae">
                 <h3>₹ <?= $row['list_price']; ?></h3>
