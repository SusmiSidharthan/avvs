      ...
      <div class="tabs-panel is-active" id="panel1">   
        <div class="checkout-ab"> 
            ...
            <div class="add-add-ab">
             <form enctype="multipart/form-data" method="post" action="<?= CUSTOM_BASE_URL . 'account/single_checkout_delivery_address_update' ?>">
              <div class="row">
                  
               <div class="col-12">
                <div class="form-group">
                 <label class="pro-txt-ad" for="formGroupExampleInput">Your Name</label>
                 <input name="name" type="text" class="form-control pro-fld-ad" id="formGroupExampleInput" value="<?= $editaddress->name ?>"  required>
                </div>
               </div>
               ...
               <div class="col-6">
                <div class="form-group">
                 ...
                 <input name="mobile" type="text" onkeypress="return (event.charCode >= 48 &amp;&amp; event.charCode <= 57)" minlength="10" maxlength="10" class="form-control pro-fld-ad" id="formGroupExampleInput" value="<?= $editaddress->phone ?>" required >
                </div>
               </div>
               ...
               <div class="col-6">
                <div class="form-group">
                 ...
                 <input name="alter_phone" type="text" onkeypress="return (event.charCode >= 48 &amp;&amp; event.charCode <= 57)" minlength="10" maxlength="10" class="form-control pro-fld-ad" id="formGroupExampleInput" value="<?= $editaddress->alter_phone ?>" >
                </div>
               </div>
              ...
              <div class="col-12">   
                  <div class="form-group edtaddab12">
                      ...
                      <input type="submit" class="consul-dg-bt12" value="Update">
                  </div>
              </div>
